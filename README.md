...
# На этом базовую настройку и конфигурирование ArchLinux системы можно считать оконченной. Система может запускать любые игры и приложения, а вы ознокомились со всем тем,базами, что вам помогут в дальнейшей эксплуатации системы.
